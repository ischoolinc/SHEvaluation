...
namespace SmartSchool.Evaluation.ImportExport
{
    ...
    class ExportSemesterEntryScore : SmartSchool.API.PlugIn.Export.Exporter
    {
        ...
        public override void InitializeExport(SmartSchool.API.PlugIn.Export.ExportWizard wizard)
        {
            ...
            // 2022-01 Cynthia 移除 "體育", "國防通識", "健康與護理","體育(原始)", "國防通識(原始)", "健康與護理(原始)",
            wizard.ExportableFields.AddRange("學年度", "學期", "成績年級", "學業", "實習科目", "專業科目", "學業(原始)", "實習科目(原始)", "專業科目(原始)", "德行", "學業成績班排名", "學業成績班排名母數", "學業成績科排名", "學業成績科排名母數", "學業成績校排名", "學業成績校排名母數", "學業成績排名類別1", "學業成績類1排名", "學業成績類1排名母數");
