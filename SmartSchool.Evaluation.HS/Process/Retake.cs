...
namespace SmartSchool.Evaluation.Process
{
    public partial class Retake : SmartSchool.Evaluation.Process.RibbonBarBase
    {
        public Retake()
        {
            ...
            buttonItem52["建議重補修名單-依科目"].BeginGroup = true;
            buttonItem52["建議重補修名單-依科目"].Click += new System.EventHandler(this.buttonItem1_Click);
            buttonItem52["建議重補修名單-依學生"].Click += new System.EventHandler(this.buttonItem2_Click);
            buttonItem52["重補修成績匯入表"].Click += new System.EventHandler(this.buttonItem3_Click);
