...
{
    /// <summary>
    /// 裝級距、均標等資訊   (特定)學年度、學期、(特定)班級(的)學生身上修課紀錄(有特定識別)的 科目 之 *級距等資料。
    /// </summary>
    class IntervalInfoByClass
    {
        /// <summary>
        /// 對應到 rank_matrix 的 rank Name 
        /// </summary>
        ...
        public IntervalInfoByClass(string subjectName)
        {
