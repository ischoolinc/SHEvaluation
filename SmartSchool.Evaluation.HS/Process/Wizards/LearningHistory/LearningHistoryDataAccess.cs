                    ...
                    jInfo.detail = new List<JSubjectDetail>
                        {
                            ...
                            CreateJSubjectDetail("4.4.9", "身分別", string.IsNullOrWhiteSpace(ssr.StudType) ? "3" : ssr.StudType),
            ...
            foreach (var ssr in scores)
            {
                if (ssr.checkPass)
                {
                    ...
                    jInfo.detail = new List<JSubjectDetail>
                  {
                    ...
                    CreateJSubjectDetail("6.4.9", "身分別", string.IsNullOrWhiteSpace(ssr.StudType) ? "3" : ssr.StudType),
